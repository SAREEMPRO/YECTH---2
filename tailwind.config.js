    ...
    extend: {
      colors: {
        ...
        'brand-orange': {
          ...
          dark: "var(--color-brand-orange-dark)", /* orange-600 */
        },
        'brand-blue-dark': "var(--color-brand-blue-dark)", /* blue-800 */
        surface: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 12px 24px rgba(21, 101, 192, 0.15)',
        'emergency': '0 4px 16px rgba(255, 152, 0, 0.3)',
      },
      animation: {
